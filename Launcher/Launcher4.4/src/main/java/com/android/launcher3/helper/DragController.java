...
import com.android.launcher3.view.DeleteDropTarget;
...
public class DragController
{
    ...
    {
        LogFileUtil.v(Launcher.TAG, "DragController construct start");
        Resources r = launcher.getResources();
        mLauncher = launcher;
        mHandler = new Handler();
        mScrollZone = r.getDimensionPixelSize(R.dimen.scroll_zone); // 20dp
        mVelocityTracker = VelocityTracker.obtain();
        
        float density = r.getDisplayMetrics().density;
        mFlingToDeleteThresholdVelocity = (int)(r.getInteger(R.integer.config_flingToDeleteMinVelocity) * density); // - 1000
        LogFileUtil.v(Launcher.TAG, "DragController construct end mFlingToDeleteThresholdVelocity = "
    ...
    {
        LogFileUtil.v("DragController.onInterceptTouchEvent " + ev + " mDragging=" + mDragging);
