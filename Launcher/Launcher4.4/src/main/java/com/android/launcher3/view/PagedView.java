 ...
 */
public abstract class PagedView extends BaseViewGroup implements ViewGroup.OnHierarchyChangeListener
{
        ...
        for (int i = startIndex; i != endIndex; i += delta)
        {
            ...
            if (child.getVisibility() != View.GONE)
            {
                ...
                else
                {
                    ...
                    {
                        childTop +=
                            (getViewportHeight() - mInsets.top - mInsets.bottom - verticalPadding - child.getMeasuredHeight()) / 2;
                    }
                }
    ...
    {
        mTmpRect.set(mViewport.left - mViewport.width() / 2,
            mViewport.top,
                            ...
                            && pageUnderPointIndex != mSidePageHoverIndex && mScroller.isFinished())
                        {
                            ...
                            mSidePageHoverRunnable = new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    int lowerIndex =
                                        (dragViewIndex < pageUnderPointIndex) ? dragViewIndex + 1 : pageUnderPointIndex;
                                    int upperIndex =
                                        (dragViewIndex > pageUnderPointIndex) ? dragViewIndex - 1 : pageUnderPointIndex;
