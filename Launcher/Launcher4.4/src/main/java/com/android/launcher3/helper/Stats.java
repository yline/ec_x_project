...
public class Stats
{
    ...
    {
        LogFileUtil.v(Launcher.TAG, "Stats Construct start");
        mLauncher = launcher;
        ...
        if (LOCAL_LAUNCH_LOG)
        {
            ...
            {
                LogFileUtil.e(TAG, "unable to create stats log: " + e);
                mLog = null;
            }
            catch (IOException e)
            {
                LogFileUtil.e(TAG, "unable to write to stats log: " + e);
                mLog = null;
            }
        }
        ...
        LogFileUtil.v(Launcher.TAG, "Stats Construct end");
    }
    ...
    private void loadStats()
    {
        ...
        LogFileUtil.v(TAG, "loadStats inited");
    }
}
