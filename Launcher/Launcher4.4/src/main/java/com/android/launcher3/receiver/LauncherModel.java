...
import com.android.launcher3.InstallWidgetReceiver;
 ...
 * for the Launcher.
 */
public class LauncherModel extends BaseReceiver
{
    ...
    {
        LogFileUtil.v(Launcher.TAG, "LauncherModel construct start");
        final Context context = app.getContext();
        
        mAppsCanBeOnRemoveableStorage = Environment.isExternalStorageRemovable(); // false
        mApp = app;
        mBgAllAppsList = new AllAppsList(iconCache, appFilter);
        mIconCache = iconCache;
        
        mDefaultIcon = Utilities.createIconBitmap(mIconCache.getFullResDefaultActivityIcon(), context); // 获取显示默认图片
        
        final Resources res = context.getResources();
        Configuration config = res.getConfiguration();
        mPreviousConfigMcc = config.mcc; // 0
        LogFileUtil.v(Launcher.TAG, "LauncherModel construct end");
    }
     ...
     */
    public static void addOrMoveItemInDatabase(Context context, ItemInfo item, long container, long screenId,
        int cellX, int cellY)
    {
    ...
    static ArrayList<ItemInfo> getItemsInLocalCoordinates(Context context)
    {
        ...
        Cursor c =
            cr.query(LauncherSettings.Favorites.CONTENT_URI, new String[] {LauncherSettings.Favorites.ITEM_TYPE,
                ...
                LauncherSettings.Favorites.CELLX, LauncherSettings.Favorites.CELLY, LauncherSettings.Favorites.SPANX,
                        ...
                        case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                            ...
                            for (ItemInfo info : sBgItemsIdMap.values())
                            {
                                if (info.container == item.id)
                                {
                                    ...
                                    String msg =
                                        "deleting a folder (" + item + ") which still " + "contains items (" + info
                                            + ")";
                                    Log.e(TAG, msg);
                                }
                            }
    ...
    {
        LogFileUtil.v("Launcher Model receiver start intent = " + intent + ",action = " + intent.getAction());
        if (DEBUG_LOADERS)
    ...
    private class LoaderTask implements Runnable
    {
            ...
            AtomicBoolean deleteOnItemOverlap)
        {
            ...
            if (item.container == LauncherSettings.Favorites.CONTAINER_HOTSEAT)
            {
                ...
                if (occupied.containsKey(LauncherSettings.Favorites.CONTAINER_HOTSEAT))
                {
                    ...
                    {
                        Log.e(TAG,
                            "Error loading shortcut into hotseat " + item + " into position (" + item.screenId + ":"
            ...
            synchronized (sBgLock)
            {
                        ...
                        try
                        {
                            ...
                            switch (itemType)
                            {
                                ...
                                case LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET:
                                    ...
                                    {
                                        String log =
                                            "Deleting widget that isn't installed anymore: id=" + id + " appWidgetId="
                                                + appWidgetId;
                                        Log.e(TAG, log);
                ...
                if (itemsToRemove.size() > 0)
                {
                    ContentProviderClient client =
                        contentResolver.acquireContentProviderClient(LauncherSettings.Favorites.CONTENT_URI);
                    // Remove dead items
        ...
        private void bindWorkspace(int synchronizeBindPage, final boolean isUpgradePath)
        {
            ...
            final int currentScreen =
                isLoadingSynchronously ? synchronizeBindPage : oldCallbacks.getCurrentWorkspaceScreen();
            ...
            mDeferredBindRunnables.clear();
            bindWorkspaceItems(oldCallbacks,
                otherWorkspaceItems,
                otherAppWidgets,
                otherFolders,
    ...
    public static ArrayList<ItemInfo> filterItemInfos(Collection<ItemInfo> infos, ItemInfoFilter f)
    {
    ...
    List<WidgetMimeTypeHandlerData> resolveWidgetsForMimeType(Context context, String mimeType)
    {
        ...
        final List<ResolveInfo> activities =
            packageManager.queryIntentActivities(supportsIntent, PackageManager.MATCH_DEFAULT_ONLY);
    ...
    public static class WidgetAndShortcutNameComparator implements Comparator<Object>
    {
        ...
        public final int compare(Object a, Object b)
        {
            ...
            {
                labelA =
                    (a instanceof AppWidgetProviderInfo) ? ((AppWidgetProviderInfo)a).label
            ...
            {
                labelB =
                    (b instanceof AppWidgetProviderInfo) ? ((AppWidgetProviderInfo)b).label
