...
import com.android.launcher3.helper.FocusHelper.AppsCustomizeTabKeyEventListener;
import com.yline.base.BaseTabHost;

public class AppsCustomizeTabHost extends BaseTabHost implements LauncherTransitionable, TabHost.OnTabChangeListener,
    Insettable
{
    ...
    {
        int bgAlpha =
            (int)(255 * (getResources().getInteger(R.integer.config_appsCustomizeSpringLoadedBgAlpha) / 100f));
