...
public interface DropTarget
{
    ...
    public static class DragEnforcer implements DragController.DragListener
    {
        ...
        {
            LogFileUtil.v(Launcher.TAG, "DragEnforcer init");
        ...
        public void onDragEnter()
        {
            ...
            if (dragParity != 1)
            {
                LogFileUtil.e(TAG, "onDragEnter: Drag contract violated: " + dragParity);
            }
        }
        ...
        public void onDragExit()
        {
            ...
            if (dragParity != 0)
            {
                LogFileUtil.e(TAG, "onDragExit: Drag contract violated: " + dragParity);
            }
        }
