...
public final class Utilities
{
    ...
    public static Bitmap createIconBitmap(Drawable icon, Context context)
    {
        ...
        { // we share the statics :-(
            ...
            int width = sIconWidth; // T1,72
            int height = sIconHeight; // T1,72
            ...
            int sourceWidth = icon.getIntrinsicWidth(); // T1,72
            int sourceHeight = icon.getIntrinsicHeight(); // T1,72
            if (sourceWidth > 0 && sourceHeight > 0)
            {
                // Scale the icon proportionally to the icon dimensions
                final float ratio = (float)sourceWidth / sourceHeight; // T1,1.0
            ...
            int textureWidth = sIconTextureWidth; // T1,72
            int textureHeight = sIconTextureHeight; // T1,72
            
            final Bitmap bitmap = Bitmap.createBitmap(textureWidth, textureHeight, Bitmap.Config.ARGB_8888);
            final Canvas canvas = sCanvas;
            canvas.setBitmap(bitmap);
            
            final int left = (textureWidth - width) / 2; // T1,0
            final int top = (textureHeight - height) / 2; // T1,0
    ...
    {
        LogFileUtil.v(Launcher.TAG, "initStatics init");
        final Resources resources = context.getResources();
