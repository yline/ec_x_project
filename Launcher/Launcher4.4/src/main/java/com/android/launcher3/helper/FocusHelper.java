...
import com.android.launcher3.view.AccessibleTabView;
import com.android.launcher3.view.BubbleTextView;
import com.android.launcher3.view.CellLayout;
import com.android.launcher3.view.FocusOnlyTabWidget;
...
import com.android.launcher3.view.PagedViewGridLayout;
import com.android.launcher3.view.PagedViewWidget;
import com.android.launcher3.view.ShortcutAndWidgetContainer;
...
public class FocusHelper
{
     ...
     */
    public static class AppsCustomizeTabKeyEventListener implements View.OnKeyListener
    {
        public boolean onKey(View v, int keyCode, KeyEvent event)
        {
    ...
    private static View getClosestIconOnLine(CellLayout layout, ViewGroup parent, View v, int lineDelta)
    {
        ...
        if (0 <= newRow && newRow < cellCountY)
        {
            ...
            while (index != endIndex)
            {
                ...
                {
                    float tmpDistance =
                        (float)Math.sqrt(Math.pow(tmpLp.cellX - lp.cellX, 2) + Math.pow(tmpLp.cellY - lp.cellY, 2));
