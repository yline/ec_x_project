...
import com.android.launcher3.info.FolderInfo.FolderListener;
import com.yline.base.BaseLinearLayout;

/**
 * An icon that can appear on in the workspace representing an {@link UserFolder}.
 */
public class FolderIcon extends BaseLinearLayout implements FolderListener
{
        ...
        IconCache iconCache)
    {
        ...
        if (error)
        {
            throw new IllegalStateException("DROP_IN_ANIMATION_DURATION must be greater than "
                + "INITIAL_ITEM_ANIMATION_DURATION, as sequencing of adding first two items " + "is dependent on this");
        }
        ...
        int index, Runnable postAnimationRunnable, DragObject d)
    {
        ...
        if (animateView != null)
        {
            ...
            dragLayer.animateView(animateView,
                from,
                to,
                finalAlpha,
                1,
