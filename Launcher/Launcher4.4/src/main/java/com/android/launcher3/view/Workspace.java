...
import com.android.launcher3.activity.Launcher.CustomContentCallbacks;
import com.android.launcher3.activity.Launcher.LauncherTransitionable;
import com.android.launcher3.activity.WallpaperCropActivity;
import com.android.launcher3.activity.WallpaperPickerActivity;
import com.android.launcher3.base.DragScroller;
...
import com.android.launcher3.base.LauncherAnimatorUpdateListener;
import com.android.launcher3.helper.DragController;
import com.android.launcher3.helper.HolographicOutlineHelper;
import com.android.launcher3.helper.IconCache;
import com.android.launcher3.helper.LauncherViewPropertyAnimator;
import com.android.launcher3.helper.SpringLoadedDragController;
import com.android.launcher3.helper.FocusHelper.IconKeyEventListener;
...
import com.android.launcher3.info.PendingAddItemInfo;
import com.android.launcher3.info.ShortcutInfo;
import com.android.launcher3.info.PendingAddItemInfo.PendingAddShortcutInfo;
...
import com.android.launcher3.receiver.UninstallShortcutReceiver;
import com.android.launcher3.view.FolderIcon.FolderRingAnimator;
    ...
    DragController.DragListener, LauncherTransitionable, ViewGroup.OnHierarchyChangeListener, Insettable
{
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        LogFileUtil.v(Launcher.TAG, "Workspace construct start and HolographicOutlineHelper obtain");
        ...
        mWorkspaceFadeInAdjacentScreens = res.getBoolean(R.bool.config_workspaceFadeAdjacentScreens); // true
        mFadeInAdjacentScreens = false;
        mWallpaperManager = WallpaperManager.getInstance(context);
        
        LogFileUtil.v(Launcher.TAG, "Workspace TypedArray recycle");
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Workspace, defStyle, 0);
        mSpringLoadedShrinkFactor = res.getInteger(R.integer.config_workspaceSpringLoadShrinkPercentage) / 100.0f; // 0.9
        mOverviewModeShrinkFactor = res.getInteger(R.integer.config_workspaceOverviewShrinkPercentage) / 100.0f; // 0.58
        mOverviewModePageOffset = res.getDimensionPixelSize(R.dimen.overview_mode_page_offset); // 130
        mCameraDistance = res.getInteger(R.integer.config_cameraDistance); // 18 000
        mOriginalDefaultPage = mDefaultPage = a.getInt(R.styleable.Workspace_defaultScreen, 1); // 0
        a.recycle();
        
        LogFileUtil.v(Launcher.TAG, "setOnHierarchyChangeListener & setHapticFeedbackEnabled");
    ...
    {
        LogFileUtil.v(Launcher.TAG, "init");
        // Context context = getContext();
        mCurrentPage = mDefaultPage; // 0
        ...
        display.getSize(mDisplaySize); // T1,800,1232
        
        mMaxDistanceForFolderCreation = (0.55f * grid.iconSizePx); // 44
        mFlingThresholdVelocity = (int)(FLING_THRESHOLD_VELOCITY * mDensity); // 500 * 1.0
    }
    ...
    class WallpaperOffsetInterpolator implements Choreographer.FrameCallback
    {
        ...
        {
            LogFileUtil.v(Launcher.TAG, "WallpaperOffsetInterpolator construct start");
            mChoreographer = Choreographer.getInstance();
            mInterpolator = new DecelerateInterpolator(1.5f);
            LogFileUtil.v(Launcher.TAG, "WallpaperOffsetInterpolator construct end");
        }
        ...
        private float wallpaperOffsetForCurrentScroll()
        {
            ...
            else
            {
                ...
                int offsetForLayoutTransitionAnimation =
                    isLayoutRtl() ? getPageAt(getChildCount() - 1).getLeft() - getFirstChildLeft() : 0;
    ...
    protected void screenScrolled(int screenCenter)
    {
        ...
        boolean shouldOverScroll =
            (mOverScrollX < 0 && (!hasCustomContent() || isLayoutRtl()))
    ...
    */
    ...
    public Animator getChangeStateAnimation(final State state, boolean animated, int delay, int snapPage)
    {
        ...
        if (animated)
        {
            ...
            {
                pageIndicatorAlpha =
                    ObjectAnimator.ofFloat(getPageIndicator(), "alpha", finalHotseatAndPageIndicatorAlpha);
            }
        ...
        if (stateIsSpringLoaded)
        {
            ...
            animateBackgroundGradient(getResources().getInteger(R.integer.config_appsCustomizeSpringLoadedBgAlpha) / 100f,
                false);
        }
        else if (stateIsOverview)
        {
    ...
    private void drawDragView(View v, Canvas destCanvas, int padding, boolean pruneToDrawable)
    {
        ...
        else
        {
            ...
            else if (v instanceof BubbleTextView)
            {
                ...
                clipRect.bottom =
                    tv.getExtendedPaddingTop() - (int)BubbleTextView.PADDING_V + tv.getLayout().getLineTop(0);
            }
            else if (v instanceof TextView)
            {
                final TextView tv = (TextView)v;
                clipRect.bottom =
                    tv.getExtendedPaddingTop() - tv.getCompoundDrawablePadding() + tv.getLayout().getLineTop(0);
            }
    ...
    public Bitmap createDragBitmap(View v, Canvas canvas, int padding)
    {
        ...
        if (v instanceof TextView)
        {
            Drawable d = ((TextView)v).getCompoundDrawables()[1];
            b =
                Bitmap.createBitmap(d.getIntrinsicWidth() + padding,
        ...
        if (d.dragSource != this)
        {
            ...
            mTargetCell =
                findNearestArea((int)mDragViewVisualCenter[0],
                    ...
                    mTargetCell);
            float distance =
                dropTargetLayout.getDistanceFromCell(mDragViewVisualCenter[0], mDragViewVisualCenter[1], mTargetCell);
            ...
            mTargetCell =
                dropTargetLayout.createArea((int)mDragViewVisualCenter[0],
                    (int)mDragViewVisualCenter[1],
                    minSpanX,
                    minSpanY,
                    spanX,
        ...
        float distance, boolean external, DragView dragView, Runnable postAnimationRunnable)
    {
        ...
        if (aboveShortcut && willBecomeShortcut)
        {
            ...
            if (animate)
            {
                fi.performCreateAnimation(destInfo,
                    v,
                    sourceInfo,
                    dragView,
                    folderLocation,
    ...
    public void onDrop(final DragObject d)
    {
        ...
        else if (mDragInfo != null)
        {
            ...
            if (dropTargetLayout != null && !d.cancelled)
            {
                ...
                if (!mInScrollArea
                    && createUserFolderIfNecessary(cell,
                        container,
                        dropTargetLayout,
                        mTargetCell,
                        distance,
                ...
                if (foundCell)
                {
                    ...
                    LauncherModel.modifyItemInDatabase(mLauncher,
                        info,
                        container,
                        screenId,
                        lp.cellX,
        ...
        if (orientation == CellLayout.LANDSCAPE)
        {
            if (mLandscapeCellLayoutMetrics == null)
            {
                ...
                mLandscapeCellLayoutMetrics.set(grid.calculateCellWidth(width, countX),
                    grid.calculateCellHeight(height, countY),
                    0,
                    0);
            }
    ...
    public void onDragOver(DragObject d)
    {
        ...
        if (mDragTargetLayout != null)
        {
            ...
            {
                mDragTargetLayout.visualizeDropLocation(child,
                    mDragOutline,
    ...
    class ReorderAlarmListener implements OnAlarmListener
    {
        ...
        public void onAlarm(Alarm alarm)
        {
            ...
            mTargetCell =
                mDragTargetLayout.createArea((int)mDragViewVisualCenter[0],
                    (int)mDragViewVisualCenter[1],
                    minSpanX,
                    minSpanY,
                    spanX,
        ...
        boolean insertAtFirst, DragObject d)
    {
        ...
        if (info instanceof PendingAddItemInfo)
        {
            ...
            if (findNearestVacantCell)
            {
                ...
                int[] resultSpan = new int[2];
                mTargetCell =
                    cellLayout.createArea((int)mDragViewVisualCenter[0],
                        (int)mDragViewVisualCenter[1],
                        minSpanX,
                        minSpanY,
                        info.spanX,
        ...
        else
        {
            ...
            switch (info.itemType)
            {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                    view =
                        FolderIcon.fromXml(R.layout.folder_icon, mLauncher, cellLayout, (FolderInfo)info, mIconCache);
                    break;
                default:
            ...
            if (touchXY != null)
            {
                ...
                if (createUserFolderIfNecessary(view,
                    container,
                    cellLayout,
                    mTargetCell,
                    distance,
        ...
        final Runnable onCompleteRunnable, int animationType, final View finalView, boolean external)
    {
        ...
        getFinalPositionForDropAnimation(finalPos,
            scaleXY,
            dragView,
            cellLayout,
            info,
        ...
        else
        {
            ...
            dragLayer.animateViewIntoPosition(dragView,
                from.left,
                from.top,
                finalPos[0],
                finalPos[1],
    ...
    public void updateShortcuts(ArrayList<AppInfo> apps)
    {
        ArrayList<ShortcutAndWidgetContainer> childrenLayouts = getAllShortcutAndWidgetContainers();
        for (ShortcutAndWidgetContainer layout : childrenLayouts)
        {
