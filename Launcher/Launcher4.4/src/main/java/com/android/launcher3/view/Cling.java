...
public class Cling extends BaseFrameLayout implements Insettable, View.OnClickListener, View.OnLongClickListener,
    View.OnTouchListener
{
    ...
    public void setFocusedHotseatApp(int drawableId, int appRank, ComponentName cn, String title, String description)
    {
        ...
        if (hotseat != null && appIconId > -1 && appRank > -1 && !title.isEmpty() && !description.isEmpty())
        {
            ...
            mFocusedHotseatAppBounds =
                new Rect(pos.left, pos.top, pos.left + Utilities.sIconTextureWidth, pos.top
