...
import com.android.launcher3.helper.FolderAutoScrollHelper;
import com.android.launcher3.helper.IconCache;
import com.android.launcher3.helper.FocusHelper.FolderKeyEventListener;
 ...
 */
public class Folder extends BaseLinearLayout implements DragSource, View.OnClickListener, View.OnLongClickListener,
    DropTarget, FolderListener, TextView.OnEditorActionListener, View.OnFocusChangeListener
{
        ...
        if (readingOrderGreaterThan(target, empty))
        {
            ...
            for (int y = startY; y <= target[1]; y++)
            {
                ...
                for (int x = startX; x <= endX; x++)
                {
                    ...
                    if (mContent.animateChildToPosition(v,
                        empty[0],
                        empty[1],
    ...
    private int getContentAreaHeight()
    {
        ...
        int maxContentAreaHeight =
            grid.availableHeightPx - 4 * grid.edgeMarginPx - workspacePadding.top - workspacePadding.bottom
                - getPaddingTop() - getPaddingBottom() - mFolderNameHeight;
