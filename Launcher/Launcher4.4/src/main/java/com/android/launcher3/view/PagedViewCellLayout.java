 ...
 */
public class PagedViewCellLayout extends BaseViewGroup implements Page
{
    ...
    public PagedViewCellLayout(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        LogFileUtil.v(Launcher.TAG, "PagedViewCellLayout construct added");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (widthSpecMode == MeasureSpec.AT_MOST)
        {
            ...
            newHeight =
                getPaddingTop() + getPaddingBottom() + (mCellCountY * mCellHeight) + ((mCellCountY - 1) * mHeightGap);
