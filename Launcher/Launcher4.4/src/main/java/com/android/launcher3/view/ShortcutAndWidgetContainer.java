...
public class ShortcutAndWidgetContainer extends BaseViewGroup
{
    ...
    {
        super(context);
        LogFileUtil.v(Launcher.TAG, "ShortcutAndWidgetContainer construct init");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        LogFileUtil.v("childCount = " + count + ",width = " + widthSpecSize + ",heightSpecSize = " + heightSpecSize);
    ...
    {
        LogFileUtil.v(Launcher.TAG, "ShortcutAndWidgetContainer getCellContentHeight");
        final LauncherAppState app = LauncherAppState.getInstance();
        final DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
