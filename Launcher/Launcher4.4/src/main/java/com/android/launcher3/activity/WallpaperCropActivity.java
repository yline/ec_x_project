    ...
    protected static class BitmapCropTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        private void regenerateInputStream()
        {
            ...
            else
            {
                ...
                {
                    Log.w("WallpaperCropActivity", "regenerateInputStream close fail ", t);
                }
        ...
        public boolean cropBitmap()
        {
            ...
            if (mInStream != null)
            {
                ...
                if (mOutWidth > 0 && mOutHeight > 0 || mRotation > 0)
                {
                    ...
                    Bitmap tmp =
                        Bitmap.createBitmap((int)returnRect.width(), (int)returnRect.height(), Bitmap.Config.ARGB_8888);
                    if (tmp != null)
                    {
