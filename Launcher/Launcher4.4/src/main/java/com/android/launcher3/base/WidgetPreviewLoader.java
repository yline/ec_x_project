...
import com.android.launcher3.view.PagedViewCellLayout;
...
public class WidgetPreviewLoader
{
    ...
    public Bitmap getPreview(final Object o)
    {
        ...
        synchronized (mUnusedBitmaps)
        {
            ...
            while ((unusedBitmap == null || !unusedBitmap.isMutable() || unusedBitmap.getWidth() != mPreviewBitmapWidth || unusedBitmap.getHeight() != mPreviewBitmapHeight)
    ...
    public static class CacheDb extends SQLiteOpenHelper
    {
        ...
        public CacheDb(Context context)
        {
            ...
            LogFileUtil.v(Launcher.TAG, "CacheDb Construct intied");
    ...
    public static void removePackageFromDb(final CacheDb cacheDb, final String packageName)
    {
        ...
        new AsyncTask<Void, Void, Void>()
        {
            public Void doInBackground(Void... args)
            {
                ...
                db.delete(CacheDb.TABLE_NAME, CacheDb.COLUMN_NAME + " LIKE ? OR " + CacheDb.COLUMN_NAME + " LIKE ?", // SELECT query
                    new String[] {WIDGET_PREFIX + packageName + "/%", SHORTCUT_PREFIX + packageName + "/%"} // args to SELECT query
                );
                synchronized (sInvalidPackages)
                {
    ...
    private Bitmap readFromDb(String name, Bitmap b)
    {
        ...
        Cursor result = db.query(CacheDb.TABLE_NAME, new String[] {CacheDb.COLUMN_PREVIEW_BITMAP}, // cols to return
    ...
    public Bitmap generateWidgetPreview(AppWidgetProviderInfo info, Bitmap preview)
    {
        ...
        return generateWidgetPreview(info.provider,
            info.previewImage,
            info.icon,
            cellSpans[0],
            cellSpans[1],
